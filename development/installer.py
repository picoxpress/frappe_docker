...
def create_site_in_bench(args):
    ...
    apps.remove("frappe")
    new_site_cmd.append(f"--install-app=erpnext")
    new_site_cmd.append(f"--install-app=helpdesk")
    new_site_cmd.append(f"--install-app=picoxpress")
    new_site_cmd.append(f"--install-app=hrms")
